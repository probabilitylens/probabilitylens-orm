...
def run_pipeline(params):
    ...
    weights,pos=build_portfolio(signals,prices,params["capital"],params["portfolio"])

    pnl_data=run_pnl_pipeline(pos,prices,params["capital"],params["costs"])
    ...
    exec_rep=run_execution_pipeline(pos,state["positions"],prices,params["execution"])
